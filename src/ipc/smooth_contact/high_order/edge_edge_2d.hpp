...
namespace ipc {
class EdgeEdge2D : public SmoothCollision<max_vert_2d> {
public:
    constexpr static int max_size = Collision<max_vert_2d>::max_size;
    EdgeEdge2D(
        const long& id0,
        const long& id1,
    ...
    inline int num_vertices() const override { return 4; }
    inline int n_dofs() const override { return num_vertices() * 2; }
    CollisionType type() const override { return CollisionType::EdgeEdge; }
