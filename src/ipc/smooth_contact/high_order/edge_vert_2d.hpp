...
namespace ipc {
class EdgeVertex2D : public SmoothCollision<max_vert_2d> {
public:
    EdgeVertex2D(
        const long& id0,
        const long& id1,
    ...
    inline int num_vertices() const override { return 5; }
    inline int n_dofs() const override { return num_vertices() * 2; }
    CollisionType type() const override { return CollisionType::EdgeVertex; }
